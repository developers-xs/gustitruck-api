...
INSERT INTO roles (description, ability) VALUES ('Administrador', '{"permissions": ["*"],"home":"tasks"}');

insert into usuarios (usuario, nombre, primer_apellido, segundo_apellido, contrasena, role) values('abenavides', 'Antonio', 'Benavides', 'Hernandez', 'ogaitnas', 1);
